...
public class Magic {
    ...
    public static final String COMMAND_THREADS  = "--threads";
    ...
    public static final String HELP_MSG =
            "usage: java ... [" + COMMAND_DUMP + "] [" + COMMAND_MAX + " N] " +
                "[" + COMMAND_FILE + " FILE] [" + COMMAND_THREADS +
                " THREADS]\n" +
            "where:\n" +
            ...
            "  FILE     is the name of a database file, \"" + DEFAULT_DB_FILE +
                "\" if omitted\n" +
            "  THREADS  is the amount of threads for crawling, " +
                DEFAULT_THREAD_COUNT + " if omitted\n" +
